...
def entry(out, enmloc, side):
    if out == True and side == "atk":
        ...
        if loc == "1":
            ...
            if enmpres == True:
                print(f"\nYou enter through {e1} and an enemy is there.")

                choice = input("1) Identify and take cover (2 TP)\n"
                                "2) Take cover (1 TP)\n\n")
            else:
                print(f"\nYou enter through {e1}. There are no enemies.")
            ...
            if enmpres == True:
                ...
                print(f"\nYou enter through {e2}. There are no enemies.")
            ...
            if enmpres == True:
                print(f"\nYou enter through {e3} and an enemy is there.")

                choice = input("1) Identify and take cover (2 TP)\n"
                                "2) Take cover (1 TP)\n\n")
            else:
                print(f"\nYou enter through {e3}. There are no enemies.")

                choice = input("1) Move (0.5 TP)\n"
                                "2) Use ability (2 TP)\n"
                                "3) Take cover (1 TP)\n\n")
    else:
        print("Pick a bomb site.")
